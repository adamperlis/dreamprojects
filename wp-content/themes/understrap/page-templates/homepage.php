...
?>
			...
			<div class="row mission--section">
					...
					<div class="row about--section text-center" data-aos="fade-up" data-aos-easing="ease" data-aos-mirror="true" data-aos-duration="1500" data-aos-offset="400">
							<div class="col-12 col-sm-8 d-block center-block text-center mx-auto">
								<h2 class="display-2 black">Win an Interview</h2>
								<p class="black">Dream Projects is meant to prepare you for your next role and those lucky few to be announced as Winner or Runners Up could land an interview with a top tier company.</p>
								<img src="<?php echo get_template_directory_uri() ?>/img/academy-logo-black.svg" />
							</div>
					</div>
